...
```shell
CUSTOM_TEMPLATES_DIRECTORY="/var/lib/zagros/templates/"
```
...
```shell
mkdir /var/lib/zagros/templates/sing-box
```
...
```
Now, restart your Zagros and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart Zagros.
